...
## 2026-06-30 (9) — RSVP deadline 31 → 21 juillet 2026
- **Date limite de réponse changée au 21 juillet 2026** (était 31 juillet). Site (`index.html`
  lead RSVP) + `wedding-details.md`.
- **Carte**: la date limite n'y figurait plus → ajoutée près du QR, en 2 lignes :
  « Confirmation souhaitée avant le 21 juillet 2026 » / « Infos & programme détaillé en ligne ».
